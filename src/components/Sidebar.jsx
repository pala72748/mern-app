                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <TbCategoryPlus style={{fontSize:20}}/>
                        Product Category
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open &&
                            "rotate-180"}`}
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <IoChatboxOutline style={{fontSize:20}}/>
                        Blog
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open &&
                            "rotate-180"}`}
