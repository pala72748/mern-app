...
const UpdateProductCategory = () => {
    ...
    const getcat = async () => {
        try {
            const result = await axios.get("http://localhost:3000/product-category/getcategory");
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:3000/product-category/getcategory/${aid}`);
                setViewcatdata({
                    ...viewcatdata,
                    "cat_name": response.data.cat_name,
                    "cat_url": response.data.cat_url,
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('cat_name', viewcatdata.cat_name);
        formData.append('cat_url', viewcatdata.cat_url);
        if (imageFile) {
          formData.append('cover', imageFile);
        }
    
        try {
          const res = await axios.put(`http://localhost:3000/product-category/updatecategory/${aid}`, formData, {
            headers: {
