...
const Addblog = () => {
    ...
    const getcat = async () => {
        try {
            const result = await axios.get(
                'https://home-s4qk.onrender.com/blog-category/getcategory',
            );
    ...
    const addblogHandeler = async (e) => {
        ...
        formData.append('blog_cat', blogcat);
        formData.append('blog_desc', editorContent);
        formData.append('blog_short_desc', shortEditorContent);
        ...
        try {
            ...
            const res = await axios.post(
                'https://home-s4qk.onrender.com/blog/blog',
                formData,
                {
                    headers: {
    ...
    const delcat = async (id) => {
        try {
            const res = await axios.delete(
                `https://home-s4qk.onrender.com/blog/deleteblog/${id}`,
            );
            getcat();
        } catch (error) {
            console.log(error);
                            ...
                            <div className="p-6.5">
                                <div className="mb-4.5">
                                    <label className="mb-2.5 block text-black dark:text-white">
                                        blog Name <span className="text-meta-1">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        name="blog_name"
